...
For_convertation = str(input("Введите строку для преобразования в лист:"))
print(list(For_convertation))

For_convertation = str(input("Введите строку для преобразования в кортеж:"))
print(tuple(For_convertation))

For_convertation = str(input("Введите строку для преобразования в set:"))
